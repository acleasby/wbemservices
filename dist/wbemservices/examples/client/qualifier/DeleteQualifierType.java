...
/**
 * Deletes the specified qualifier in the specified namespace.
 */
public class DeleteQualifierType {
    public static void main(String args[]) throws CIMException {
	CIMClient cc = null;
	String protocol = CIMClient.CIM_XML;
	if (args.length < 5) {
	    System.out.println("Usage: DeleteQualifierType host user passwd parentNS" +
	...
	try {
	    ...
	    System.out.println("deleteQualifierType(objectpath) deletes qualifier " + QualifierName);
	    System.out.println("   in namespace " + ParentNameSpace + " on " + Host);
	    CIMObjectPath qtop = new CIMObjectPath(QualifierName);
	    cc.deleteQualifierType(qtop);
	}
	catch (Exception e) {
