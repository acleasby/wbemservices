...
copy %EXAMPLES%\client\method\*_Provider.class %CIMOMLIB%
...
set MOF=TestMethod.mof
cd %WBSERBIN%
call mofcomp -v -u %USER% -p %PASSWD% %EXAMPLES%\client\method\%MOF%
cd %EXAMPLES%

set PROGRAM=GetClass
set CLASS=Class_M
