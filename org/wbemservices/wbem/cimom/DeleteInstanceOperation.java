...
class DeleteInstanceOperation extends CIMOMOperation {
    ...
    DeleteInstanceOperation(CIMOMServer cimom, ServerSecurity ss,
    				CIMDeleteInstanceOp cimop,
				String version) {
	...
	try {
	    ...
	    // cimom.intdeleteInstance(ns, op, false);
	    cimom.deleteInstance(version, ns, op, ss);
