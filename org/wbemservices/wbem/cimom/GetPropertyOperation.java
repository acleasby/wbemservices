...
class GetPropertyOperation extends CIMOMOperation {
    ...
    GetPropertyOperation(CIMOMServer cimom, ServerSecurity ss,
			CIMGetPropertyOp cimop, String version) {
	...
	try {
	    ...
	    // result = (Object)cimom.intgetProperty(ns, op, propname, false);

	    result = cimom.getProperty(version, ns, op, propname, ss);
