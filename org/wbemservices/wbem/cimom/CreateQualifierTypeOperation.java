...
class CreateQualifierTypeOperation extends CIMOMOperation {
    ...
    CreateQualifierTypeOperation(CIMOMServer cimom, ServerSecurity ss,
			CIMCreateQualifierTypeOp cimop, String version) {
	...
	try {
	    ...
	    cimom.createQualifierType(version, ns, op, qt, ss);
