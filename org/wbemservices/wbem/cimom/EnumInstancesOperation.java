...
public class EnumInstancesOperation extends CIMOMOperation {
    ...
    public EnumInstancesOperation(CIMOMServer cimom, ServerSecurity ss,
    				CIMEnumInstancesOp cimop, String version) {
	...
	//  result = (Object)cimom.intenumInstances(ns, op, deep, 
	//				localOnly, false);

	    result = cimom.enumerateInstances(version, ns, op, 
