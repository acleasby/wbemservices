...
public class EnumClassNamesOperation extends CIMOMOperation {
    ...
    public EnumClassNamesOperation(CIMOMServer cimom, ServerSecurity ss,
			CIMEnumClassNamesOp cimop, String version) {
	...
	try {
	    ...
	    // result = (Object)cimom.intenumClass(ns, op, deep);

	    result = cimom.enumerateClassNames(version, ns, op, 
				               new Boolean(deep), ss);
