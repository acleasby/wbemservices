...
if [ "$3" = "" ]; then
	echo "USAGE: sh test_qualifier.sh user password parentNS protocol [host]"
...
CLASSPATH=".:$WBEM"
PROGRAM=CreateQualifierType
cd $EXAMPLES/client/qualifier
echo "**********************************************"
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_boolean boolean $PROTOCOL 
$JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_boolean boolean $PROTOCOL 

PROGRAM=GetQualifierType
cd $EXAMPLES/client/qualifier
echo "**********************************************"
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_boolean $PROTOCOL 
...
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_uint32 uint32 $PROTOCOL 
...
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_uint32 $PROTOCOL 
...
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_uint64 uint64 $PROTOCOL 
...
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_uint64 $PROTOCOL 
$JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_uint64 $PROTOCOL 
pause

PROGRAM=SetQualifierType
cd $EXAMPLES/client/qualifier
echo "**********************************************"
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_sint sint32 $PROTOCOL 
...
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_sint $PROTOCOL 
...
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_sint sint64 $PROTOCOL 
...
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_real real32 $PROTOCOL 
...
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_real $PROTOCOL 
...
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_real real64 $PROTOCOL 
...
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_string string $PROTOCOL 
...
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_string $PROTOCOL 
$JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT q_string $PROTOCOL 
pause

PROGRAM=EnumQualifierType
cd $EXAMPLES/client/qualifier
echo "**********************************************"
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT $PROTOCOL 
$JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD $PARENT $PROTOCOL 
pause

PROGRAM=DeleteQualifierType
cd $EXAMPLES/client/qualifier
echo "**********************************************"
echo "Running $PROGRAM on $HOST:/$PARENT over $PROTOCOL"
echo "**********************************************"
