...
if [ "$3" = "" ]; then
	echo "USAGE: sh test_connect.sh user password protocol [host]"
...
echo "**********************************************"
echo "Running $PROGRAM to $HOST over RMI"
echo "**********************************************"
echo $JAVA $CLASSPATH $PROGRAM $HOST $USER $PASSWD !protocol $PROTOCOL 
