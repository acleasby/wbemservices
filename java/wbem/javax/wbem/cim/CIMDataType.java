...
public class CIMDataType implements Serializable {
    ...
    public static final int findTypeForClass(Class c) {
        if (UnsignedInt8.class.isAssignableFrom(c)) {
            return CIMDataType.UINT8;
        }
        if (Byte.class.isAssignableFrom(c)) {
            return CIMDataType.SINT8;
        }
        if (UnsignedInt16.class.isAssignableFrom(c)) {
            return CIMDataType.UINT16;
        }
        if (Short.class.isAssignableFrom(c) || short.class.isAssignableFrom(c)) {
            return CIMDataType.SINT16;
        }
        if (UnsignedInt32.class.isAssignableFrom(c)) {
            return CIMDataType.UINT32;
        }
        if (Integer.class.isAssignableFrom(c) || int.class.isAssignableFrom(c)) {
            return CIMDataType.SINT32;
        }
        if (UnsignedInt64.class.isAssignableFrom(c)) {
            return CIMDataType.UINT64;
        }
        ...
        if (CIMDateTime.class.isAssignableFrom(c)) {
            return CIMDataType.DATETIME;
        }
        if (CIMObjectPath.class.isAssignableFrom(c)) {
            return CIMDataType.REFERENCE;
        }
        if (CIMInstance.class.isAssignableFrom(c)) {
            return CIMDataType.OBJECT;
        }
        if (CIMClass.class.isAssignableFrom(c)) {
            return CIMDataType.CLASS;
        }
        return CIMDataType.INVALID;
    }
